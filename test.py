...
def test(args):
    ...
    if args.model=='td4-psp18':
        path_num = 4
        vid_seq = cityscapesLoader(img_path=args.img_path,in_size=(449,577))
        vid_seq.load_frames()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--_td4_psp18_path",nargs="?",type=str,
            default="./checkpoint/td4p18-nyu.pkl",help="Path_to_PSP_Model",)

    parser.add_argument("--_td2_psp50_path",nargs="?",type=str,
            default="./checkpoint/td2p50-nyu.pkl",help="Path_to_PSP_Model",)
