...
class td4_psp18(nn.Module):
    ...
    def __init__(self,
        ...
        self.layer_norm1 = Layer_Norm([57,73])
        self.layer_norm2 = Layer_Norm([57,73])
        self.layer_norm3 = Layer_Norm([57,73])
        self.layer_norm4 = Layer_Norm([57,73])

        self.head1 = FCNHead(512*self.expansion*1, nclass, norm_layer, chn_down=2)
        self.head2 = FCNHead(512*self.expansion*1, nclass, norm_layer, chn_down=2)
        self.head3 = FCNHead(512*self.expansion*1, nclass, norm_layer, chn_down=2)
        self.head4 = FCNHead(512*self.expansion*1, nclass, norm_layer, chn_down=2)
